...
<div class="doctor-detail">
    ...
    <a href="formdatlich.php?id=<?php echo $doctor['id']; ?>&Ten=<?php echo $doctor['Ten']; ?>&picture=<?php echo $doctor['Hinh']; ?>&price=0" 
       class="btn btn-primary" 
       style="display: inline-block; padding: 10px 20px; background-color: #2575fc; color: #fff; text-decoration: none; border-radius: 5px; font-weight: bold; text-align: center; transition: background-color 0.3s ease;">
        Đặt lịch hẹn
    </a>
</div>
