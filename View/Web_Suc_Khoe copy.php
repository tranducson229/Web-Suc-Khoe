...
// Function to set up auto sliding
function autoSlide() {
    slideIndex++;
    showSlides(slideIndex);
...
autoSlide();
    ...
    <div id="comment">
        <h2 id ="feedback">ĐÁNH GIÁ CỦA KHÁCH HÀNG</h2>
        <div id="comment-body">
            <div class="prev_1">
                <a href="#">
            ...
            <ul id="list-comment">
                <li class="item">
                    <div class="avatar">
                        <img src="../Media/avatar_4.webp" alt="" style="border-radius: 55%; width: 10%;">
                    ...
                    <div class="text-cmt">
                        <p id="cmt_1">Em cảm ơn bác sĩ rất nhiều. Dù chỉ là khám bệnh từ xa nhưng bác sĩ vẫn cho em cảm giác an toàn từ 1 vị bác sĩ nhiệt tình và rất có tâm. Cảm ơn Health Care vì nhờ kênh khám bệnh từ xa này mà những người bệnh ở tỉnh xa như tụi em đang rất hoang mang ko biết khám bệnh ở đâu, ko biết tìm đâu 1 nơi mình tin tưởng tuyệt đối thì Health Care đã giúp e làm chuyện đó. Cảm ơn Health Care rất nhiều.
                        </p>
                    </div>
                </li>
                <li class="item">
                    <div class="avatar">
                        <img src="../Media/avatar_1.png" alt="">
                    ...
                    <div class="text-cmt">
                        <p id="cmt_2">Đội ngũ hỗ trợ rất tốt, kịp thời. Bác sĩ nhiệt tình, giỏi chuyên môn, hướng dẫn và giải đáp được thắc mắc, lo âu của bệnh nhân, giúp người bệnh an tâm để điều trị.</p>
                    </div>
                </li>
                <li class="item">
                    <div class="avatar">
                    ...
                    <div class="text-cmt">
                        <p id="cmt_3"> Anh chị em nghiệp vụ của Health Care thực sự chu đáo, tận tình đối với khách hàng- những bệnh nhân và người nhà. Cảm ơn các anh chị. Và mong hệ thống (Web) của Health Care sớm hoàn chỉnh và liên tục được cập nhật để ngày cảng thuận lợi, hiện đại hơn. Bác sĩ khám, tư vấn rất tận tình, rõ ràng, chuyên nghiệp, tác động tích cực đến người bệnh. Cảm ơn đội ngũ bác sĩ nhiều !
                        </p>
                    </div>
                </li>
            </ul>
